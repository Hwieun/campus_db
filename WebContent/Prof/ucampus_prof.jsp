...
<%
	System.out.println("");
	System.out.println("/--ucmapus_prof--/");
...
%>
	...
	<div id="grid3">
		<div id="left">
			...
			<br>
			<br>
			<p class="one"><a href="../Prof/table_prof.jsp?flag=1">▶ 강의 자료실</a></p>
			<br>	
			<br>
			<br> 
			<p class="one"><a href="../Prof/student_info.jsp">▶  수강생 조회 </a></p>
		</div>
		<div id="right">
		<table style="margin-top: 60px;">
				...
				<tr>
					<td class="one"><%=session.getAttribute("subject_name1")%></td>
					<td class="one"><%=session.getAttribute("prof_name")%></td>
					<td class="one"><a href="../Prof/table_prof.jsp?flag=1">강의실 ▶</a></td>
				</tr>
			</table>			
		</div>
	</div>
